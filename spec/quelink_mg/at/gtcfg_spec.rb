...
RSpec.describe QuelinkMg::At::Gtcfg do
  it 'creates command when params are valid' do
    ...
    expect(described_class.new(params:).message).to eq 'AT+GTCFG=gl310m,gl310m,gl310m,0,0.0,1,5,001F,,,0FFF,0,1,1,300,2,0,20491231235959,0,0000,0,10,,,FFFF$'
  end
